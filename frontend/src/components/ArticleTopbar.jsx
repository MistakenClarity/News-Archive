const ArticleTopbar = ({ sortKey, setSortKey }) => {
    ...
    return (
        <div className='min-w-[478px] w-auto flex justify-center my-2 mx-2 p-2 bg-white dark:bg-zinc-900 shadow w-40 min-w-[165px] box-border border-2 min-w-36 dark:text-slate-200 rounded border-zinc-500'>
