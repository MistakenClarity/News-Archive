...
const NewsHome = () => {
    ...
    return (
        ...
        <div className='flex'>
            <div id="top" className='font-sans bg-white flex dark:bg-zinc-900 w-fit'>
                {keyGroups && <ArticlesSidebar key={keyGroups._id} keyGroups={keyGroups} />}
                <div className='w-72 bg-white dark:bg-zinc-900'>
            ...
            <div className='font-sans bg-white dark:bg-zinc-900 flex h-lvd w-full'>
